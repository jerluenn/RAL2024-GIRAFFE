...
class Hysteresis_MPC_Controller: 
    ...
    def __init__(self, alpha_ten, alpha_h, rho, sigma, gamma_tension, n, beta): 
    ...
    def createModel(self): 
        ...
        psi_function = self.beta[0]*self.sgn_approx(tension_dot, h) + self.beta[1]*self.sgn_approx(tension, tension_dot) + self.beta[2]*self.sgn_approx(tension, h) + self.beta[3]*self.sgn_approx(tension_dot, 1) + self.beta[4]*self.sgn_approx(h, 1) + self.beta[5]*self.sgn_approx(tension, 1) + self.beta[6]
        h_dot = tension_dot*(self.rho - psi_function*self.mod_approx(h)**self.n)

        f_expl = vertcat(tension_dot, h_dot)
